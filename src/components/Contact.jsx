  ...
  return (
    <section id="contact" ref={sectionRef} className="py-20 bg-gray-50 dark:bg-gray-900">
      <div className="max-w-5xl mx-auto px-4">
        ...
        <div 
          ref={contentRef} 
          className="grid md:grid-cols-1 gap-8 transition-opacity duration-1000 opacity-0"
        >
          <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-xl p-8">
            ...
            <div className="space-y-6">
              <div className="flex items-start">
                ...
                <div className="ml-4">
                  ...
                  <p className="text-gray-600 dark:text-gray-300">kumkumsheralgi1ga22cs091@gmail.com</p>
                </div>
              </div>
              ...
              <div className="flex items-start">
                ...
                <div className="ml-4">
                  ...
                  <p className="text-gray-600 dark:text-gray-300">+91 6360347379</p>
                </div>
              </div>
            ...
            <div className="mt-10">
              ...
              <div className="flex space-x-4">
                <a href="https://github.com/kumsquare" target="_blank" rel="noopener noreferrer" className="p-3 bg-gray-100 dark:bg-gray-700 rounded-full hover:bg-gray-200 dark:hover:bg-gray-600 transition-colors">
                ...
                <a href="https://www.linkedin.com/in/kumkum-heralgi-6581342a9/" target="_blank" rel="noopener noreferrer" className="p-3 bg-gray-100 dark:bg-gray-700 rounded-full hover:bg-gray-200 dark:hover:bg-gray-600 transition-colors">
                  <svg className="w-5 h-5 text-gray-700 dark:text-gray-300" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
